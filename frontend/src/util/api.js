...
const request = async (endpoint, options = {}) => {
  ...
  if (!res.ok) {
    ...
    // ➕ AJOUT : on attache le code HTTP à l'erreur pour que l'appelant puisse distinguer
    // un vrai cold-start (503) d'une erreur permanente (400/401/500...) et décider s'il
    // vaut la peine de retenter automatiquement ou non.
