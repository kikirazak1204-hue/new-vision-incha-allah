...
export default function Login() {
  ...
  // Détermination de la route selon le rôle reçu
  const dashboardFor = (user = {}) => {
    ...
    if (role.includes('client') || role.includes('user')) return '/dashboard-client';
    
    return '/'; // Redirection par défaut (Accueil) si rôle non reconnu
  };
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // Redirection via React Router vers la bonne URL
      window.setTimeout(() => {
